// Vendorizzato da cubejs (https://github.com/ldez/cubejs), licenza MIT — vedi la
// nota completa in cube.js. Adattamento minimo da CommonJS a modulo ES: l'import
// di Cube avviene qui in testa invece che con require('./cube') inline, e la
// variabile "Cube" e' stata tolta dalla lista di dichiarazioni locali qui sotto
// per non oscurare l'import (Cube deve restare il riferimento condiviso, dato che
// questo file estende Cube.prototype in-place). Nessuna logica e' stata modificata.
