// Vendorizzato da cubejs (https://github.com/ldez/cubejs), autore originale akheron,
// pacchetto npm mantenuto da ldez, licenza MIT (vedi LICENSE in questa cartella).
// NON installato come dipendenza npm: il pacchetto pubblicato dichiara erroneamente
// "npm" stesso come dipendenza di produzione, trascinando ~525 pacchetti transitivi
// e decine di vulnerabilita note. Il codice del solver in se non ha dipendenze
// runtime (vedi i soli due file cube.js e solve.js), quindi lo si vendorizza qui
// direttamente, con un adattamento minimo da CommonJS a modulo ES (vedi in fondo
// al file). Nessuna logica dell algoritmo e stata modificata.
(function() {
  // Centers
  ...
  //# Globals (adattato per l'uso come modulo ES: vedi nota in cima al file)
  globalThis.__CubieCubeJS = Cube;

}).call({});

export default globalThis.__CubieCubeJS;
